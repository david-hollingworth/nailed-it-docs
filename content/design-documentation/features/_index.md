...
perspective, derived from the [Product Requirements Document](/nailed-it-docs/design-documentation/nailed-it-prd).
Features are grouped to match the PRD's own "Requirements by Feature" sections, with
one additional file (00) for shared entity behaviour and one (10) for account and
settings features drawn from the PRD's Technical Foundation section.
